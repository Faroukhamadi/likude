...
func (c *Comment) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(c.Points); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "float32",
...
func (c *Community) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     c.ID,
		Type:   "Community",
		Fields: make([]*Field, 4),
	...
	if buf, err = json.Marshal(c.About); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
...
func (po *Post) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(po.Points); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "float32",
...
func (r *Reply) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     r.ID,
		Type:   "Reply",
		Fields: make([]*Field, 4),
	...
	if buf, err = json.Marshal(r.Points); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "float32",
...
func (t *Topic) Node(ctx context.Context) (node *Node, err error) {
	...
	err = t.QueryTopicRelations().
		Select(topicrelated.FieldID).
		Scan(ctx, &node.Edges[1].IDs)
	if err != nil {
		return nil, err
	}
...
func (tr *TopicRelated) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     tr.ID,
		Type:   "TopicRelated",
		Fields: make([]*Field, 2),
	...
	var buf []byte
	if buf, err = json.Marshal(tr.TopicID); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(tr.RelatedTopicID); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "int",
...
func (u *User) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(u.Karma); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "float32",
	...
	err = u.QueryCommunities().
		Select(community.FieldID).
		Scan(ctx, &node.Edges[1].IDs)
	if err != nil {
		return nil, err
	}
