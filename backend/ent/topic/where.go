...
// HasRelatedTopics applies the HasEdge predicate on the "related_topics" edge.
func HasRelatedTopics() predicate.Topic {
	return predicate.Topic(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RelatedTopicsTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, RelatedTopicsTable, RelatedTopicsPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasRelatedTopicsWith applies the HasEdge predicate on the "related_topics" edge with a given conditions (other predicates).
func HasRelatedTopicsWith(preds ...predicate.Topic) predicate.Topic {
	return predicate.Topic(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasTopicRelations applies the HasEdge predicate on the "topic_relations" edge.
func HasTopicRelations() predicate.Topic {
	return predicate.Topic(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TopicRelationsTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, true, TopicRelationsTable, TopicRelationsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasTopicRelationsWith applies the HasEdge predicate on the "topic_relations" edge with a given conditions (other predicates).
func HasTopicRelationsWith(preds ...predicate.TopicRelated) predicate.Topic {
	return predicate.Topic(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TopicRelationsInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, true, TopicRelationsTable, TopicRelationsColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
