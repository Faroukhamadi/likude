...
type TopicEdges struct {
	// RelatedTopics holds the value of the related_topics edge.
	RelatedTopics []*Topic `json:"related_topics,omitempty"`
	// TopicRelations holds the value of the topic_relations edge.
	TopicRelations []*TopicRelated `json:"topic_relations,omitempty"`
...
// RelatedTopicsOrErr returns the RelatedTopics value or an error if the edge
// was not loaded in eager-loading.
func (e TopicEdges) RelatedTopicsOrErr() ([]*Topic, error) {
	if e.loadedTypes[0] {
		return e.RelatedTopics, nil
	}
	return nil, &NotLoadedError{edge: "related_topics"}
}

// TopicRelationsOrErr returns the TopicRelations value or an error if the edge
// was not loaded in eager-loading.
func (e TopicEdges) TopicRelationsOrErr() ([]*TopicRelated, error) {
	if e.loadedTypes[1] {
		return e.TopicRelations, nil
	}
	return nil, &NotLoadedError{edge: "topic_relations"}
}
...
// QueryRelatedTopics queries the "related_topics" edge of the Topic entity.
func (t *Topic) QueryRelatedTopics() *TopicQuery {
	return (&TopicClient{config: t.config}).QueryRelatedTopics(t)
}

// QueryTopicRelations queries the "topic_relations" edge of the Topic entity.
func (t *Topic) QueryTopicRelations() *TopicRelatedQuery {
	return (&TopicClient{config: t.config}).QueryTopicRelations(t)
}
